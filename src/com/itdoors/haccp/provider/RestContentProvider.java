...
public class RestContentProvider extends ContentProvider {
	...
	static{
		
		{
			...
			sContoursProjectionMap.put(HaccpContract.Contours._ID, 		  HaccpDatabase.Tables.CONTOURS + "." + HaccpContract.Contours._ID);
			sContoursProjectionMap.put(HaccpContract.Contours.UID, 		  HaccpDatabase.Tables.CONTOURS + "." + HaccpContract.Contours.UID);
			sContoursProjectionMap.put(HaccpContract.Contours.NAME,	 	  HaccpDatabase.Tables.CONTOURS + "." + HaccpContract.Contours.NAME);
			sContoursProjectionMap.put(HaccpContract.Contours.SERVICE_ID, HaccpDatabase.Tables.CONTOURS + "." + HaccpContract.Contours.SERVICE_ID);
			sContoursProjectionMap.put(HaccpContract.Contours.COLOR,      HaccpDatabase.Tables.CONTOURS + "." + HaccpContract.Contours.COLOR);
			
			sContoursProjectionMap.put(HaccpContract.Contours.SERVICE_ID_PROJECTION,   HaccpContract.Services._ID_FULL +" AS " + HaccpContract.Contours.SERVICE_ID_PROJECTION);
			sContoursProjectionMap.put(HaccpContract.Contours.SERVICE_UID_PROJECTION,  HaccpContract.Services.UID_FULL +" AS " + HaccpContract.Contours.SERVICE_UID_PROJECTION);
			sContoursProjectionMap.put(HaccpContract.Contours.SERVICE_NAME_PROJECTION, HaccpContract.Services.NAME_FULL +" AS " + HaccpContract.Contours.SERVICE_NAME_PROJECTION);
		}
		
		{
			...
			sPointsMap.put(HaccpContract.Points._ID, 			  HaccpDatabase.Tables.POINTS + "." + HaccpContract.Points._ID);
			sPointsMap.put(HaccpContract.Points.UID, 			  HaccpDatabase.Tables.POINTS + "." + HaccpContract.Points.UID);
			sPointsMap.put(HaccpContract.Points.NAME,			  HaccpDatabase.Tables.POINTS + "." + HaccpContract.Points.NAME);
			sPointsMap.put(HaccpContract.Points.PLAN_ID,		  HaccpDatabase.Tables.POINTS + "." + HaccpContract.Points.PLAN_ID);
			sPointsMap.put(HaccpContract.Points.CONTOUR_ID,		  HaccpDatabase.Tables.POINTS + "." + HaccpContract.Points.CONTOUR_ID);
			sPointsMap.put(HaccpContract.Points.STATUS_ID, 		  HaccpDatabase.Tables.POINTS + "." + HaccpContract.Points.STATUS_ID);
			sPointsMap.put(HaccpContract.Points.POINT_GROUP_ID,   HaccpDatabase.Tables.POINTS + "." + HaccpContract.Points.POINT_GROUP_ID);
			sPointsMap.put(HaccpContract.Points.INSTALATION_DATE, HaccpDatabase.Tables.POINTS + "." + HaccpContract.Points.INSTALATION_DATE);
			sPointsMap.put(HaccpContract.Points.IMG_LATITUDE,     HaccpDatabase.Tables.POINTS + "." + HaccpContract.Points.IMG_LATITUDE);
			sPointsMap.put(HaccpContract.Points.IMG_LONGTITUDE,   HaccpDatabase.Tables.POINTS + "." + HaccpContract.Points.IMG_LONGTITUDE);
			sPointsMap.put(HaccpContract.Points.MAP_LATITUDE,     HaccpDatabase.Tables.POINTS + "." + HaccpContract.Points.MAP_LATITUDE);
			sPointsMap.put(HaccpContract.Points.MAP_LONGTITUDE,   HaccpDatabase.Tables.POINTS + "." + HaccpContract.Points.MAP_LONGTITUDE);
		}
		
		{
			sPointsInCObjByContProjMap = new HashMap<String, String>(sPointsMap);
		
			sPointsInCObjByContProjMap.put(HaccpContract.Points.PLANS_ID_PROJECTION, 	HaccpContract.Plans._ID_FULL +" AS " + HaccpContract.Points.PLANS_ID_PROJECTION);
			sPointsInCObjByContProjMap.put(HaccpContract.Points.PLANS_UID_PROJECTION,	HaccpContract.Plans.UID_FULL +" AS " + HaccpContract.Points.PLANS_UID_PROJECTION);
			sPointsInCObjByContProjMap.put(HaccpContract.Points.PLANS_NAME_PROJECTION,	HaccpContract.Plans.NAME_FULL +" AS " + HaccpContract.Points.PLANS_NAME_PROJECTION);
		}
		
		{
			sPointInfoMap = new HashMap<String, String>(sPointsMap);
		
			sPointInfoMap.put(HaccpContract.Points.PLANS_ID_PROJECTION, 	HaccpContract.Plans._ID_FULL +" AS " + HaccpContract.Points.PLANS_ID_PROJECTION);
			sPointInfoMap.put(HaccpContract.Points.PLANS_UID_PROJECTION,	HaccpContract.Plans.UID_FULL +" AS " + HaccpContract.Points.PLANS_UID_PROJECTION);
			sPointInfoMap.put(HaccpContract.Points.PLANS_NAME_PROJECTION,	HaccpContract.Plans.NAME_FULL +" AS " + HaccpContract.Points.PLANS_NAME_PROJECTION);
			
			sPointInfoMap.put(HaccpContract.Points.CONTOUR_ID_PROJECTION, 	HaccpContract.Contours._ID_FULL +" AS " + HaccpContract.Points.CONTOUR_ID_PROJECTION);
			sPointInfoMap.put(HaccpContract.Points.CONTOUR_UID_PROJECTION,	HaccpContract.Contours.UID_FULL +" AS " + HaccpContract.Points.CONTOUR_UID_PROJECTION);
			sPointInfoMap.put(HaccpContract.Points.CONTOUR_NAME_PROJECTION,	HaccpContract.Contours.NAME_FULL +" AS " + HaccpContract.Points.CONTOUR_NAME_PROJECTION);
			sPointInfoMap.put(HaccpContract.Points.CONTOUR_SLUG_PROJECTION,	HaccpContract.Contours.SLUG_FULL +" AS " + HaccpContract.Points.CONTOUR_SLUG_PROJECTION);
			
			sPointInfoMap.put(HaccpContract.Points.STATUS_ID_PROJECTION, 	HaccpContract.Statuses._ID_FULL +" AS " + HaccpContract.Points.STATUS_ID_PROJECTION);
			sPointInfoMap.put(HaccpContract.Points.STATUS_UID_PROJECTION,	HaccpContract.Statuses.UID_FULL +" AS " + HaccpContract.Points.STATUS_UID_PROJECTION);
			sPointInfoMap.put(HaccpContract.Points.STATUS_NAME_PROJECTION,	HaccpContract.Statuses.NAME_FULL +" AS " + HaccpContract.Points.STATUS_NAME_PROJECTION);
			sPointInfoMap.put(HaccpContract.Points.STATUS_SLUG_PROJECTION,	HaccpContract.Statuses.SLUG_FULL +" AS " + HaccpContract.Points.STATUS_SLUG_PROJECTION);
			
			sPointInfoMap.put(HaccpContract.Points.GROUP_ID_PROJECTION, 	HaccpContract.Groups._ID_FULL +" AS " + HaccpContract.Points.GROUP_ID_PROJECTION);
			sPointInfoMap.put(HaccpContract.Points.GROUP_UID_PROJECTION,	HaccpContract.Groups.UID_FULL +" AS " + HaccpContract.Points.GROUP_UID_PROJECTION);
			sPointInfoMap.put(HaccpContract.Points.GROUP_NAME_PROJECTION,	HaccpContract.Groups.NAME_FULL +" AS " + HaccpContract.Points.GROUP_NAME_PROJECTION);
	...
	public Cursor query(Uri uri, String[] projection, String selection,
		...
		switch (uriMatcher.match(uri)) {
			...
			case POINTS_ID:
			{
				qBuilder.setTables(
						...
						" INNER JOIN " +  HaccpDatabase.Tables.POINT_STATUSES + 
							" ON " +  "(" + HaccpDatabase.Tables.POINTS + "." + HaccpContract.Points.STATUS_ID  + " = " +
									    HaccpDatabase.Tables.POINT_STATUSES + "." + HaccpContract.Points.UID + 
								   ")" +
						" INNER JOIN " +  HaccpDatabase.Tables.POINT_GROUPS + 
							" ON " +  "(" + HaccpDatabase.Tables.POINTS + "." + HaccpContract.Points.POINT_GROUP_ID  + " = " +
										HaccpDatabase.Tables.POINT_GROUPS + "." + HaccpContract.Groups.UID + 
								   ")" +
						 " INNER JOIN " +  HaccpDatabase.Tables.CONTOURS + 
							" ON " +  "(" + HaccpDatabase.Tables.POINTS + "." + HaccpContract.Points.CONTOUR_ID  + " = " +
									    HaccpDatabase.Tables.CONTOURS + "." + HaccpContract.Contours.UID + 
								   ")" +
						" INNER JOIN " +  HaccpDatabase.Tables.PLANS + 
							" ON " +  "(" + HaccpDatabase.Tables.POINTS + "." + HaccpContract.Points.PLAN_ID  + " = " +
			...
			case GROUP_ID_CHARACTERISTICS:
			{
				...
				qBuilder.appendWhere(HaccpDatabase.Tables.POINT_GROUP_CHARACTERISTICS + "." + HaccpContract.GroupCharacterisitcs.UID + "=" + HaccpContract.GroupCharacterisitcs.getGroupId(uri));
			...
			case TRANSACTIONS_PENDING:
			{
				...
				qBuilder.appendWhere(HaccpDatabase.Tables.TRANSACTIONS +"." + HaccpContract.Transactions.TRANSACTING);
			...
			{
				qBuilder.setTables(HaccpDatabase.Tables.TRANSACTIONS);
				qBuilder.appendWhere(HaccpDatabase.Tables.TRANSACTIONS +"." + HaccpContract.Transactions._ID);
				qBuilder.appendWhere("=");
			...
			case COMPANIES_ID: break;
			case COMPANY_OBJECTS_ID:break;
			default:
	...
	public Uri insert(Uri uri, ContentValues values) {
		...
		switch (uriMatcher.match(uri)) {
			case POINT_ID_STATISTICS:
			{
				...
				Logger.Logi(getClass(), "insert statistics with uri: " + uri.toString() +", " + "values: " + values.toString());
			...
			case TRANSACTIONS_PENDING:
			{
	            ...
	            values.put( HaccpContract.Transactions.TRANSACTING, TransactionState.TRANSACTION_PENDING);
	            values.put( HaccpContract.Transactions.RESULT, 0 );
	            values.put( HaccpContract.Transactions.TRANSACTING_DATE, CalendarUtils.toTimeStamp( CalendarUtils.currentDate()) );
	            values.put( HaccpContract.Transactions.TRY_COUNT,  0);
	             
	            // Insert into database
	            try {
	            	Logger.Logi(getClass(), "start insert pending transaction  with values:" + values.toString());
	            	requestId = db.insertOrThrow(HaccpDatabase.Tables.TRANSACTIONS, null, values);
	            } catch ( SQLException e ) {
	                Logger.Loge( TAG, "Cannot insert transaction in PENDING status with uri:" + uri.toString() );
	                return null;
	            }
	            ...
	            ContentResolver.requestSync(
	            		GenericAccountService.GetAccount(), HaccpContract.CONTENT_AUTHORITY, new Bundle() );
	...
	public int delete(Uri uri, String selection, String[] selectionArgs) {
		...
		switch (uriMatcher.match(uri)) {
			case TRANSACTIONS_ID:
			{
				whereBuilder.append(HaccpDatabase.Tables.TRANSACTIONS + "." + HaccpContract.Transactions._ID);
				whereBuilder.append("=");
				whereBuilder.append(HaccpContract.Transactions.getTransactionId(uri));
				
				Logger.Logi(getClass(), "removing transaction with uri :" + uri.toString() +", " + "where : " + whereBuilder.toString());
				int count = db.delete(HaccpDatabase.Tables.TRANSACTIONS, whereBuilder.toString(), null);
				return count;
			}
	...
	public int update(Uri uri, ContentValues values, String selection,
		...
		switch (uriMatcher.match(uri)) {
			case TRANSACTIONS_ID:
			{
				...
				whereSelections.append(HaccpDatabase.Tables.TRANSACTIONS +"." + HaccpContract.Transactions._ID)
					.append("=")
				...
				Logger.Logi(getClass(), "update transaction with uri: " + uri.toString() +", " + "values: " + values.toString()  );
				
				int count = db.update(HaccpDatabase.Tables.TRANSACTIONS, values, whereSelections.toString(), null);
			...
			case TRANSACTIONS_IN_PROGRESS_ID:
			{
				values.put(HaccpContract.Transactions.TRANSACTING, TransactionState.TRANSACTION_IN_PROGRESS);
				...
				Logger.Logi(getClass(), "update. uri: " + uri.toString() +", values: " + values.toString());
				int count = db.update(HaccpDatabase.Tables.TRANSACTIONS, values, whereSelections.toString(), selectionArgs);
			...
			case POINTS_ID:
			{
				...
				whereSelections.append(HaccpDatabase.Tables.POINTS + "." + HaccpContract.Points.UID)
					.append("=")
					.append(pointId);
				if(!TextUtils.isEmpty(selection)){
					whereSelections.append(" AND ( ").append(selection).append(")");
				...
				Logger.Logi(getClass(), "update point. uri: " + uri.toString() +", values: " + values.toString());
				int count = db.update(HaccpDatabase.Tables.POINTS, values, whereSelections.toString(), selectionArgs);
