...
public abstract class BaseRESTCommand  implements RESTCommand{
    ...
    public BaseRESTCommand(Context context, HttpMethod method, Uri uri, Bundle params, Parser parser, long requestId){
    ...
    */
               ...
               AuthenticationFailureException
    {
        ...
        Logger.Logi(getClass(), "execute with null authToken");
	...
	@Override
	public int handleRequest(String authToken) throws DeviceConnectionException, NetworkSystemException, WebServiceFailedException {
	 ...
	 private static HttpRequestBase createHttpRequest(String authToken, HttpMethod method, Uri uri, Bundle params) throws UnsupportedEncodingException, URISyntaxException{
