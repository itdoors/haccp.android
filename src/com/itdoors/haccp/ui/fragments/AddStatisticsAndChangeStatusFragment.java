...
public class AddStatisticsAndChangeStatusFragment extends SherlockFragment implements
    ...
    @SuppressWarnings("unused")
    public interface GroupCharacteristicsQuery {
        int _TOKEN = 2;
        String[] PROJECTION = new String[] {
    ...
    private static class MyLoadingHandler extends Handler {
        ...
        private final WeakReference<AddStatisticsAndChangeStatusFragment> mWeakRef;

        MyLoadingHandler(AddStatisticsAndChangeStatusFragment target) {
            mWeakRef = new WeakReference<AddStatisticsAndChangeStatusFragment>(target);
        }

        @Override
        public void handleMessage(Message msg) {
            if (msg.what == READY_MSG) {
                AddStatisticsAndChangeStatusFragment fragment = mWeakRef.get();
    ...
    private static class MyLoadingRunnable implements Runnable {
        ...
        MyLoadingRunnable(AddStatisticsAndChangeStatusFragment target) {
            mWeakRef = new WeakReference<AddStatisticsAndChangeStatusFragment>(target);
        }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewGroup root = (ViewGroup) inflater.inflate(
                R.layout.fragment_add_statistics_and_change_status, container,
                false);
    ...
    private void onPointLoadFinished(Cursor cursor) {
        ...
        loaderManager
                .initLoader(GroupCharacteristicsQuery._TOKEN, args,
                        AddStatisticsAndChangeStatusFragment.this);
