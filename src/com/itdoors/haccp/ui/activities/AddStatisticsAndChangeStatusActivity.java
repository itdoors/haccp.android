...
import com.itdoors.haccp.ui.fragments.AddStatisticsAndChangeStatusFragment;
import com.itdoors.haccp.ui.fragments.AddStatisticsAndChangeStatusFragment.Action;
...
public class AddStatisticsAndChangeStatusActivity extends SherlockFragmentActivity implements
        AddStatisticsAndChangeStatusFragment.OnAddPressedListener,
        ...
        GooglePlayServicesClient.OnConnectionFailedListener
{
    ...
    public void onDonePressed() {
        ...
        if (mFragment != null && mFragment.isAdded()) {
            AddStatisticsAndChangeStatusFragment fragment = (AddStatisticsAndChangeStatusFragment) mFragment;
    ...
    public void onAddPressed(HashMap<GroupCharacteristic, Double> values) {
        ...
        while (iterator.hasNext()) {
            ...
            Entry<GroupCharacteristic, Double> entry = iterator.next();
    ...
    public void onConnected(Bundle connectionHint) {
        ...
        if (mFragment == null) {
            mFragment = new AddStatisticsAndChangeStatusFragment();
