...
public class PointsListActivity extends SherlockFragmentActivity implements
    ...
    public void startActivity(Intent intent) {
        ...
        if (intent.getAction() != null && intent.getAction().equals(Intent.ACTION_SEARCH)) {
            ...
            if (bundle != null
                    && (ApiLevel.hasHoneycomb() || intent.getBundleExtra(SearchManager.APP_DATA) == null))
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        MenuItem searchItem = menu.add(Menu.NONE, 0, Menu.NONE,
                getString(R.string.search_point_label));
    ...
    private Bundle getExtraSearchInfo() {
        ...
        if (getIntent() != null && getIntent().getExtras() != null) {
            ...
            CompanyObject companyObject = (CompanyObject) getIntent().getExtras().getSerializable(
