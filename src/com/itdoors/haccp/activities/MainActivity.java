...
import com.itdoors.haccp.fragments.MenuFragment;
import com.itdoors.haccp.fragments.QRFragment;
...
public class MainActivity extends SlidingFragmentActivity implements SetQRCallback, TakeQRListener, MenuFragment.OnProfilePressedListener{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (savedInstanceState != null){
			...
			mActionMode = (MenuActionMode)savedInstanceState.getSerializable("actionBarMode");
		...
		if (mContent == null){
			...
			.beginTransaction()
			.add(R.id.main_content_frame, mContent)
			.commit();
	...
	public void onActivityResult(int requestCode, int resultCode, Intent data) {
	    ...
	    if(resultCode == Activity.RESULT_OK){
		    if(requestCode == GET_RECOGNIZED_TEXT_REQUEST_CODE){
				...
				//	Intent intent = ControlPointActivity.newInstance(this, id.intValue());
		    		Intent intent = PointDetailsActivity.newInstance(this, id.intValue());
					startActivity(intent);
					
		    	} catch (JSONException e) {
		    		e.printStackTrace();
		    		ToastUtil.ToastLong(this, getString(R.string.scanner_error));
		    	}
		    }
	    }
	...
	public void takeQR() {
			if(Camera.checkCameraHardware(this)){
				...
				ToastUtil.ToastLong(this, getResources()
	...
	public void switchContent(final Fragment fragment,String title, View selectedView, MenuActionMode actionMode) {
	...
	private void showProfile(){
		...
		switchContent(newContent, title, getMenuView(MenuFragment.profile_id), MenuActionMode.USER_PROFILE);
