...
public final class HttpHelper {
    ...
    public static void downloadViaHttp(String uri, File file, ContentType type)
            throws IOException {
    ...
    public static void downloadViaHttp(String uri, File file, String contentTypes)
            throws IOException {
     ...
     * @throws IOException
     */
    public static boolean downloadConnectionToStream(HttpURLConnection connection,
