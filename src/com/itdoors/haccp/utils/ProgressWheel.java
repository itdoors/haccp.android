...
public class ProgressWheel extends View {
    ...
    private void parseAttributes(TypedArray a) {
        ...
        circleRadius = (int) a.getDimension(R.styleable.ProgressWheel_progressCircleRadius,
                circleRadius);

        fillRadius = a.getBoolean(R.styleable.ProgressWheel_progressFillRadius, false);

        barWidth = (int) a.getDimension(R.styleable.ProgressWheel_progressBarWidth, barWidth);

        rimWidth = (int) a.getDimension(R.styleable.ProgressWheel_progressRimWidth, rimWidth);

        float baseSpinSpeed = a.getFloat(R.styleable.ProgressWheel_progressSpinSpeed,
                spinSpeed / 360.0f);
        spinSpeed = baseSpinSpeed * 360;

        barSpinCycleTime = a.getInt(R.styleable.ProgressWheel_progressBarSpinCycleTime,
