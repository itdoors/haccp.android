...
public class PointDetailsFragment extends SherlockFragment {
	...
	public static PointDetailsFragment newInstance(Point point, ArrayList<StatisticsRecord> records){
		
		PointDetailsFragment f = new PointDetailsFragment();
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
			...
			View v = inflater.inflate(R.layout.control_point_details, null);
	...
	public void fillUI(Content content) {
		...
		if(getActivity () != null) {
			...
			final StatisticsFragment mStatisticsFragment = getStatisticsFragment();
			final AttributesFragment mAttrFragment = getAttributesFragment();
	...
	private StatisticsFragment getStatisticsFragment(){
		return getActivity() == null ? null : (StatisticsFragment) getActivity().getSupportFragmentManager().findFragmentByTag(mTabsAdapter.getFragmentTag(0));
	}
	
	private AttributesFragment getAttributesFragment(){
		return getActivity() == null ? null : (AttributesFragment) getActivity().getSupportFragmentManager().findFragmentByTag(mTabsAdapter.getFragmentTag(1));
	}
	...
	public void changeStatusOnAttributes(PointStatus status) {
		if(getActivity () != null) {
			final AttributesFragment mAttributesFragment = getAttributesFragment();
			if(status != null){
