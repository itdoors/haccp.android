...
public class AddStatisticsFragment extends SherlockFragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		ViewGroup root = (ViewGroup)inflater.inflate(R.layout.add_statistics_fragment, container, false);
	...
	private View getFieldView(LayoutInflater inflater, ViewGroup container, GroupCharacteristicField field){
		...
		switch (inputType) {
			case RANGE:
			{
				...
				view = inflater.inflate(R.layout.add_statisctics_fragment_range_layout,container, false);
				...
				if(field.getCharacteristic() != null){
					...
					CP_STATUS status = getStatus(defValue, top, bottom);
	...
	private CP_STATUS getStatus(double value, double top, double bottom){
	...
	private void setStatus(CP_STATUS status, View view){
		switch (status) {
