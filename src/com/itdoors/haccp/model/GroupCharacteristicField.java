...
public class GroupCharacteristicField implements Serializable{
	...
	private GroupCharacteristic characteristic;
	private DataType dataType;
	private InputType inputType;
	
	public GroupCharacteristicField(GroupCharacteristic characteristic, DataType dataType, InputType inputType) {
	...
	public boolean equals(Object o) {
		...
		if(!(o instanceof GroupCharacteristicField)) return false;
		GroupCharacteristicField g = (GroupCharacteristicField)o;
		return (characteristic == null ? g.characteristic == null : characteristic.equals(g.characteristic)) && 
