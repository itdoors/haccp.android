...
public class PointStatus implements Serializable{
	...
	public static enum CODE { 
		...
		public static CODE fromString(String code){
			if(code.equals(WORKING.toString()))
				...
				throw new IllegalArgumentException("CODE: only  working, noaccess, missing or  broken acceptable!");
		}
		...
		public String toString() {
			switch (this) {
				...
				case NO_ACCESS: return "noaccess";
	...
	public boolean equals(Object o) {
		...
		if(!(o instanceof PointStatus)) return false;
