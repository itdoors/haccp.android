...
public class Point implements Serializable{
	...
	public Point(int id, int number, Date inDate, Plan plan, Group group, Contour contour) {
		this(id,number,inDate,plan,group,contour, null, null);
	}
	
	public Point(int id, int number, Date inDate, Plan plan, Group group, Contour contour, PointStatus status) {
		this(id,number,inDate,plan,group,contour, status, null);
	}
	
	public Point(int id, int number, Date inDate, Plan plan, Group group, Contour contour, PointStatus status, Owner owner) {
		this.id = id;
		this.number = number;
	...
	public boolean equals(Object o) {
		...
		return cp.id == id && 
			   ...
			   (installationDate == null ? cp.installationDate == null : installationDate.equals(cp.installationDate)) &&
	...
	public String toString() {
		...
		sb.append("installationDate = " + (installationDate == null ? "null" : installationDate.toString()) + ", ");
