...
public class GroupCharacteristic implements Serializable{
	...
	public GroupCharacteristic(int id, String name, String uint, String description, int max, int min, int bottom, int top) {
	...
	public boolean equals(Object o) {
		...
		return  (obj.id == id) && 
				...
				(description == null ? obj.description == null : description.equals(obj.description));
